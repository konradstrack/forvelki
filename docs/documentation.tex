...
Kod źródłowy programu w języku Forvelki składa się z ciągu instrukcji przypisania oraz wyrażeń rozdzielonych znakami nowej linii bądź średnikami.
...
\subsection{Funkcje}
Funkcje anonimowe są defiowane składnią \texttt{[<lista argumentów> -> <przypisanie>,<przypisanie>,..., <wyrażenie>]}.
...
Dostępna jest funkcja \texttt{write[x->x]}, która ma efekt uboczny - wypisanie argumentu na standardowe.
